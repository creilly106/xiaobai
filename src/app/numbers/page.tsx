        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Rule title="11–99: say it like maths">
            <p className="text-muted-foreground">
              Tens are &ldquo;digit × ten&rdquo;, then add the units. Teens skip the leading 一.
            </p>
          ...
          <Rule title="百 hundreds and 千 thousands">
            <p className="text-muted-foreground">
              Same pattern with bigger units. Inside a larger number, 10 is said in full as 一十.
            </p>
            <ul className="divide-y divide-border/50">
              <Example n={100} />
          ...
          <Rule title="零 fills gaps">
            <p className="text-muted-foreground">
              When a place in the middle is empty, say 零 once — however many zeros there are. Zeros
              at the end are silent.
            </p>
            <ul className="divide-y divide-border/50">
              <Example n={105} />
          ...
          <Rule title="两 vs 二 (both mean two)">
            <p className="text-muted-foreground">
              Count with 二 (一、二、三) and in 十-numbers (二十, 十二). Before 百, 千, 万 and 亿 —
              and before measure words (两个人) — people say 两. 二百 and 二千 aren&apos;t wrong,
              just more formal.
            </p>
            <ul className="divide-y divide-border/50">
              <Example n={2} />
          ...
          <Rule title="万: groups of four, not three">
            <p className="text-muted-foreground">
              English groups digits in threes (thousand, million). Chinese uses 万 = 10,000 and 亿 =
              100,000,000. A million is &ldquo;one hundred ten-thousands&rdquo;.
            </p>
            <ul className="divide-y divide-border/50">
              <Example n={10_000} />
            ...
            <p className="text-xs text-muted-foreground">
              Tip: put the commas every 4 digits (1,0000,0000) and read each group, adding 万 or 亿.
            </p>
          </Rule>
