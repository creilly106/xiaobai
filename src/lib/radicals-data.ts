...
export const radicals: Radical[] = [
  ...
  { number: 8, hanzi: '亠', pinyin: 'tóu', meaning: 'lid', strokes: 2, examples: ['交', '京'] },
  {
    number: 9,
    hanzi: '人',
    forms: [{ char: '亻', position: 'left side' }],
    pinyin: 'rén',
    meaning: 'person',
    strokes: 2,
    examples: ['你', '他', '们', '会'],
  ...
  },
  {
    number: 18,
    hanzi: '刀',
    forms: [{ char: '刂', position: 'right side' }],
    pinyin: 'dāo',
    meaning: 'knife',
    strokes: 2,
    examples: ['分', '别', '到'],
  ...
  },
  {
    number: 61,
    hanzi: '心',
    forms: [{ char: '忄', position: 'left side' }],
    pinyin: 'xīn',
    meaning: 'heart, mind',
    strokes: 4,
    examples: ['忙', '快', '想', '您'],
  ...
  },
  {
    number: 64,
    hanzi: '手',
    forms: [{ char: '扌', position: 'left side' }],
    pinyin: 'shǒu',
    meaning: 'hand',
    strokes: 4,
    examples: ['打', '拉', '找', '拿'],
  },
  {
    number: 66,
    hanzi: '攴',
    forms: [{ char: '攵', position: 'right side' }],
    pinyin: 'pū',
    meaning: 'strike, action',
    strokes: 4,
    examples: ['放', '教', '故'],
  },
  {
  ...
  { number: 84, hanzi: '气', pinyin: 'qì', meaning: 'air, breath', strokes: 4, examples: ['汽'] },
  {
    number: 85,
    hanzi: '水',
    forms: [{ char: '氵', position: 'left side' }],
    pinyin: 'shuǐ',
    meaning: 'water',
    strokes: 4,
    examples: ['河', '海', '洗', '泉'],
  ...
  { number: 92, hanzi: '牙', pinyin: 'yá', meaning: 'tooth', strokes: 4, examples: ['穿'] },
  {
    number: 93,
    hanzi: '牛',
    forms: [{ char: '牜', position: 'left side' }],
    pinyin: 'niú',
    meaning: 'cow, ox',
    strokes: 4,
    examples: ['物', '特'],
  },
  {
    number: 94,
    hanzi: '犬',
    forms: [{ char: '犭', position: 'left side' }],
    pinyin: 'quǎn',
    meaning: 'dog',
    strokes: 4,
    examples: ['猫', '狗', '哭'],
  },
  {
    number: 96,
    hanzi: '玉',
    forms: [{ char: '王', position: 'left side' }],
    pinyin: 'yù',
    meaning: 'jade',
    strokes: 5,
    examples: ['玩', '现', '球', '国'],
  ...
  },
  {
    number: 113,
    hanzi: '示',
    forms: [{ char: '礻', position: 'left side' }],
    pinyin: 'shì',
    meaning: 'show, spirit',
    strokes: 5,
    examples: ['祝', '福', '票'],
  ...
  { number: 119, hanzi: '米', pinyin: 'mǐ', meaning: 'rice', strokes: 6, examples: ['粉', '糖'] },
  {
    number: 120,
    hanzi: '糸',
    forms: [{ char: '纟', position: 'left side' }],
    pinyin: 'sī',
    meaning: 'silk, thread',
    strokes: 6,
    examples: ['红', '线', '给', '紧'],
  ...
  },
  {
    number: 130,
    hanzi: '肉',
    forms: [{ char: '月', position: 'left side — looks just like 月 "moon"' }],
    pinyin: 'ròu',
    meaning: 'meat, flesh',
    strokes: 6,
    examples: ['肚', '腿', '脸'],
  ...
  { number: 144, hanzi: '行', pinyin: 'xíng', meaning: 'walk, go', strokes: 6, examples: ['街'] },
  {
    number: 145,
    hanzi: '衣',
    forms: [{ char: '衤', position: 'left side' }],
    pinyin: 'yī',
    meaning: 'clothing',
    strokes: 6,
    examples: ['裤', '裙', '衬'],
  ...
  },
  {
    number: 149,
    hanzi: '言',
    forms: [{ char: '讠', position: 'left side' }],
    pinyin: 'yán',
    meaning: 'speech',
    strokes: 7,
    examples: ['说', '话', '语', '请'],
  ...
  },
  {
    number: 162,
    hanzi: '辵',
    forms: [{ char: '辶', position: 'wraps the bottom-left' }],
    pinyin: 'chuò',
  ...
  },
  {
    number: 163,
    hanzi: '邑',
    forms: [{ char: '阝', position: 'right side — "city"' }],
    pinyin: 'yì',
    meaning: 'city',
    strokes: 7,
    examples: ['都', '邮', '那'],
  ...
  },
  {
    number: 167,
    hanzi: '金',
    forms: [{ char: '钅', position: 'left side' }],
    pinyin: 'jīn',
    meaning: 'gold, metal',
    strokes: 8,
    examples: ['钱', '钟', '错'],
  ...
  },
  {
    number: 170,
    hanzi: '阜',
    forms: [{ char: '阝', position: 'left side — "mound"' }],
    pinyin: 'fù',
    meaning: 'mound, hill',
    strokes: 8,
    examples: ['阴', '阳', '院'],
  ...
  { number: 182, hanzi: '风', kangxi: '風', pinyin: 'fēng', meaning: 'wind', strokes: 4 },
  {
    number: 184,
    hanzi: '食',
    forms: [{ char: '饣', position: 'left side' }],
    pinyin: 'shí',
    meaning: 'eat, food',
    strokes: 9,
    examples: ['饭', '饺', '饿', '餐'],
